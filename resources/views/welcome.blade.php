...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <!--  sm:flex sm:justify-center sm:items-center   " -->
           ...
           <!-- List Entries -->
           <form class="orientation flex" method="post" action="{{ route('saveItem') }}" accept-charset="UTF-8">
            {{csrf_field()}}
           ...
           <ul style="margin-top: 20px;">
            ...
            <!-- array as item -->
                <li class="flex orientation <?php if($listEntry->is_complete==1){echo 'is-done';} ?>" style="align-items: space-between;">
                    <form method="post" action="{{ route('toggleComplete', $listEntry->id)}}" accept-charset="UTF-8">
                        {{csrf_field()}}    
                    ...
                    <form method="post" action="{{ route('deleteEntry', $listEntry->id)}}" accept-charset="UTF-8">
                    {{csrf_field()}}
                        <button type="submit" style="margin-left: 20px;">Delete</button>
                    </form>
                </li>    
            @endforeach
            </ul>
